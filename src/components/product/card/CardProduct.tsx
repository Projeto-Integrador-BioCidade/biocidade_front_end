  ...
  return (
    <div className='flex flex-col rounded-lg overflow-hidden justify-between bg-white my-2'>
      ...
      <div className='py-4'>
        ...
        <img src={produto.imagem_produto} className='mt-1 h-44 max-w-75 mx-auto' alt={produto.nome} />
        ...
        <div className='p-4'>
          ...
          <p className='text-sm italic text-center'>Categoria: {produto.categoria?.descricao}</p>
        </div>
      </div>
