...
function Carrosel() {
    const slides = [
        {
          url: 'https://th.bing.com/th/id/OIP.5C8f4FJK7OU3a8xdnCjdUQHaEK?rs=1&pid=ImgDetMain',
        },
        {
          url: 'https://th.bing.com/th/id/OIP.JJt583zSAgWOlgNLxVILmQHaE8?rs=1&pid=ImgDetMain',
        },
        {
    ...
    return (
        <div className=' w-full h-full  py-4 px-4 relative group'>
            <div
