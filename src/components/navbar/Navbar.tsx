...
import BioLogo from "../../assets/navbar_logo.png";
            ...
            <div>
              <form action="" className="flex">
                <input
                  ...
                  id="pesquisa"
                  name="pesquisa"
                  className="m-2 h-7 min-w-[250px] max-w-96 rounded-full border-2 border-solid border-bio-City-footer-navbar-color px-2 placeholder:px-1 placeholder:italic placeholder:text-slate-400 enabled:hover:border-gray-400 sm:text-sm"
